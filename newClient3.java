...
public class newClient3 {
    ...
    public newClient3(int Id,int serverport,int port,int downport,int downpeer, int uppeer){
    	peerId = Id;
    ...
    public static void main(String args[])
    {
        ...
        int peerId = 3;
    	newClient3 peer3 = new newClient3(peerId,ServerPort,portNumber[peerId],portNumber[downloadPeerNum[peerId]],downloadPeerNum[peerId],uploadPeerNum[peerId]);
    	peer3.run(); 	
