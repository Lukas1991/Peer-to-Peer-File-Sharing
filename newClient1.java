...
public class newClient1 {
    ...
    public newClient1(int Id,int serverport,int port,int downport,int downpeer, int uppeer){
    	peerId = Id;
    ...
    public static void main(String args[])
    {
        ...
        int peerId = 1;
    	newClient1 peer1 = new newClient1(peerId,ServerPort,portNumber[peerId],portNumber[downloadPeerNum[peerId]],downloadPeerNum[peerId],uploadPeerNum[peerId]);
    	peer1.run(); 	
