...
public class newClient4 {
    ...
    public newClient4(int Id,int serverport,int port,int downport,int downpeer, int uppeer){
    	peerId = Id;
    ...
    public static void main(String args[])
    {
        ...
        int peerId = 4;
    	newClient4 peer4 = new newClient4(peerId,ServerPort,portNumber[peerId],portNumber[downloadPeerNum[peerId]],downloadPeerNum[peerId],uploadPeerNum[peerId]);
    	peer4.run(); 	
