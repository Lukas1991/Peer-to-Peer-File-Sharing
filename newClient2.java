...
public class newClient2 {
    ...
    public newClient2(int Id,int serverport,int port,int downport,int downpeer, int uppeer){
    	peerId = Id;
    ...
    public static void main(String args[])
    {
        ...
        int peerId = 2;
    	newClient2 peer2 = new newClient2(peerId,ServerPort,portNumber[peerId],portNumber[downloadPeerNum[peerId]],downloadPeerNum[peerId],uploadPeerNum[peerId]);
    	peer2.run(); 	
